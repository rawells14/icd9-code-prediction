...
if __name__ == "__main__":
    ...
    parser.add_argument("--d_ff", type=int, default=100, required=False, dest="d_ff",
                        help="dimension of feed forward networks")
    parser.add_argument("--num_layers", type=int, default=2, required=False, dest="num_layers",
